            ...
            <div className="relative bg-white dark:bg-zinc-900 rounded-3xl p-8 border border-slate-200 dark:border-zinc-800 shadow-2xl transform hover:scale-105 transition-transform duration-500">
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-purple-100 to-purple-200 dark:from-purple-950 dark:to-purple-900 rounded-xl flex items-center justify-center">
                    <img src="/image.png" alt="KitabKosh" className="w-10 h-10 object-contain" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white font-playfair">KitabKosh</h3>
                    <p className="text-sm text-slate-600 dark:text-slate-400">Your Reading Companion</p>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-slate-50 dark:bg-zinc-800 rounded-xl p-4">
                    ...
                    <div className="text-xs text-slate-600 dark:text-slate-400">Frontend</div>
                  </div>
                  <div className="bg-slate-50 dark:bg-zinc-800 rounded-xl p-4">
        ...
        <div className={`bg-gradient-to-br from-purple-50 via-purple-100 to-purple-50 dark:from-zinc-900 dark:via-purple-950 dark:to-zinc-900 rounded-3xl p-12 md:p-16 text-center shadow-2xl border border-purple-200 dark:border-purple-800 overflow-hidden relative ${visibleSections.has('cta') ? 'animate-scale-in opacity-100' : 'opacity-0'}`}>
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto">
              Join thousands of readers who trust KitabKosh to organize their reading. 
              Sign up now and transform how you track your books.
            </p>
            <Link href="/signin">
              <Button 
                size="lg"
